...
```bash
pip install fcp-gemini-python-client
```
...
This library was extracted from the [Food Context Protocol](https://github.com/Food-Context-Protocol/fcp) project to provide a standalone, reusable Gemini 3 client for Python.
...
See [CONTRIBUTING.md](https://github.com/Food-Context-Protocol/fcp-gemini-python-client/blob/main/CONTRIBUTING.md)
