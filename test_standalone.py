#!/usr/bin/env python3
"""Quick smoke test to verify fcp-gemini-python-client is standalone."""
...
def test_imports():
    ...
    try:
        ...
        from fcp.gemini.security import validate_image_url, ImageURLError
...
def test_utils():
    """Test utils module."""
    print("\nTesting utils...")
    from fcp.gemini.utils import extract_json
...
def main():
    """Run all smoke tests."""
    print("=" * 60)
    print("fcp-gemini-python-client Standalone Smoke Test")
    print("=" * 60)
    ...
    if passed == total:
        ...
        print("fcp-gemini-python-client is standalone and working!")
        return 0
    else:
